...
public class TvViewAdapter extends RecyclerView.Adapter<TvViewAdapter.TvViewHolder> {
    private Context context;
    private List<TvShowModel> showList = new ArrayList<>();

    public TvViewAdapter(Context context) {
        this.context = context;
    }

    public void setData(List<TvShowModel> showList) {
        this.showList.clear();
    ...
    public void onBindViewHolder(@NonNull TvViewHolder holder, int position) {
        ...
        holder.showPoster.setAnimation(AnimationUtils.loadAnimation(context, R.anim.fade_transition_animation));
